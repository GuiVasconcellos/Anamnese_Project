    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            conteudo = [
                ...
                f"Profissional(ais) / Aluno(s): {data.get('aluno_names', '')}\n" if data.get('aluno_names') else None,
                
                # 2. Identificação (Formato Narrativo conforme PDF)
                "I – Identificação: " + ", ".join(filter(None, [
                    data.get('nome', ''),
                    f"nome social: {data.get('nome_social', '')}" if data.get('nome_social') else None,
                    f"sexo {data.get('sexo_biologico', '')}" if data.get('sexo_biologico') else None,
                    f"identidade de gênero: {data.get('identidade_genero', '')}" if data.get('identidade_genero') else None,
                    data.get('idade', ''),
                    f"nascido em {data.get('data_nascimento', '')}" if data.get('data_nascimento') else None,
                    data.get('raca_cor', ''),
                    ...
                    f"Nacionalidade: {data.get('nacionalidade', '')}" if data.get('nacionalidade') else None,
                    f"Procedência Próxima: {data.get('procedencia_prox', '')}" if data.get('procedencia_prox') else None,
                ...
                f"Aparelho Urinário: {data.get('isda_urinario', '')}" if data.get('isda_urinario') else None,
                f"Aparelho Reprodutor Feminino: {data.get('isda_repro_fem', '')}" if data.get('isda_repro_fem') else None,
                f"Aparelho Reprodutor Masculino: {data.get('isda_repro_masc', '')}" if data.get('isda_repro_masc') else None,
                ...
                "V – Antecedentes",
                f"Antecedentes pessoais: {data.get('ant_morbidos', '')}" if data.get('ant_morbidos') else None,
                ...
                f"Antecedentes familiares: {data.get('ant_familiares', '')}\n" if data.get('ant_familiares') else None,
                ...
                "Exame físico do aparelho respiratório:" if any([data.get('ef_resp_insp_est'), data.get('ef_resp_insp_din'), data.get('ef_resp_percussao'), data.get('ef_resp_palpacao'), data.get('ef_resp_ausculta')]) else None,
                "Inspeção:" if any([data.get('ef_resp_insp_est'), data.get('ef_resp_insp_din')]) else None,
                f"-Estática: {data.get('ef_resp_insp_est', '')}" if data.get('ef_resp_insp_est') else None,
                f"-Dinâmica: {data.get('ef_resp_insp_din', '')}" if data.get('ef_resp_insp_din') else None,
                ...
                "VIII. EXAME FÍSICO ESPECIAL (DETALHADO)" if any([data.get('ef_cabeca_detalhe'), data.get('ef_pescoco_detalhe'), data.get('ef_abdome_especial'), data.get('ef_neuro_detalhe'), data.get('ef_locomotor_detalhe')]) else None,
                f"Cabeça (Crânio, Olhos, Nariz, Ouvidos, Boca): {data.get('ef_cabeca_detalhe', '')}" if data.get('ef_cabeca_detalhe') else None,
                f"Pescoço e Tireoide: {data.get('ef_pescoco_detalhe', '')}" if data.get('ef_pescoco_detalhe') else None,
                f"Abdome (Fígado, Baço, Rins, Aorta): {data.get('ef_abdome_especial', '')}" if data.get('ef_abdome_especial') else None,
                f"Exame Neurológico: {data.get('ef_neuro_detalhe', '')}" if data.get('ef_neuro_detalhe') else None,
                f"Aparelho Locomotor: {data.get('ef_locomotor_detalhe', '')}\n" if data.get('ef_locomotor_detalhe') else None,

                "IX. CONCLUSÕES E PLANEJAMENTO",
                "------------------------------",
